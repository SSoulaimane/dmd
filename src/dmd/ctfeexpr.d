...
bool isCtfeValueValid(Expression newval)
{
    ...
    if (newval.op == TOK.address)
    {
        ...
        return tb.ty == Tpointer && ((e1.op == TOK.structLiteral || e1.op == TOK.arrayLiteral) && isCtfeValueValid(e1) || e1.op == TOK.variable || e1.op == TOK.dotVariable && isCtfeReferenceValid(e1) || e1.op == TOK.index && isCtfeReferenceValid(e1) || e1.op == TOK.slice && e1.type.toBasetype().ty == Tsarray);
    }
